...
from .views import  ExcelImportView_Questions, TestCandidatesMapView, ExcelImportView_Questions_Code, ExcelImportView_Candidateuser, ExcelImportView_CandidateLAST
...
urlpatterns = [
    ...
    path('api/trainers/<int:pk>/delete/old/', views.delete_trainer, name='delete-trainer'),
   ...
   # path('api/questions_Code/<int:question_id>/update/', views.update_question, name='update_question'),
    ...
    path('api/eligible-students/count/<int:clg_id>/', views.get_eligible_students_count, name='eligible-student-list'),
   #  path('api/candidates-eligible-list/', views.get_candidate_all_job_master, name='get_candidate_all_job_master'),
    ...
    path('api/login-view/', views.login_view, name='login_view'),
    ...
    path('trainers/', views.trainer_list_view, name='trainer-list'), 
    path('trainer/add/', views.trainer_create_view, name='trainer-add'),
    path('trainer/edit/<int:pk>/', views.trainer_update_view, name='trainer-edit'),
    path('api/trainers/<int:pk>/delete/', views.delete_trainer, name='delete-trainer'),
    path('api/trainers/all/', views.TrainerListAPIView, name='trainer-list-api'),

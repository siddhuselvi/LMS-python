...
class eligible_studentSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['id','students_id','announcement','job_id','round_of_interview','whatsapp_text','is_accept','is_offered']
...
class trainerSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        fields = ['id',
            ...
            'ifsc_code', 'branch_name', 'account_no', 'resume', 'user_name',
             'pan_number', 'gst', 'certification', 'photo', 
        ]

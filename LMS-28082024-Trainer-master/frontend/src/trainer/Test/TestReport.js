...
const TestReports = () => {
  ...
  const exportToExcel = () => {
    ...
    const wsData = filteredData.map(candidate => {
      ...
      // Define the order of columns based on the headerMap
        ...
        <div className='table-responsive'>
          <table className="product-table">
            <thead className="table-thead">
              <tr>
              <th style={{textAlign:"center"}}>College <br />
                  <select value={filters.college_id} onChange={(e) => handleFilterChange(e, 'college_id')} style={{ backgroundColor: 'white', borderRadius: '5px', width: "160px",textAlign:"center" }}>
            ...
            <tbody className="table-tbody">
              {currentData
                .filter(item =>
                  ...
                  (item.college_id && typeof item.college_id === 'string' && item.college_id.toLowerCase().includes(searchQuery.toLowerCase())) ||

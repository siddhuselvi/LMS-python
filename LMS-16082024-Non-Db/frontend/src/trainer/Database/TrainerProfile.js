...
const TrainerProfile = (username, userRole) => {
  ...
  useEffect(() => {
    ...
    // if (username.userRole === "Trainer") {
    //   try {
    //     getTrainerByUsername(username.username).then((data) => {
                ...
                <Col>
                  <div controlId="city">
                    ...
                    <input
                      ...
                      disabled={!isEditable}
                      onChange={(e) => setTrainerDataResponse({ ...trainerDataResponse, city: e.target.value })}
                    />
                  </div>
                </Col>
                <Col>
                  <div controlId="state">
                    ...
                    <input
                      ...
                      disabled={!isEditable}
                      onChange={(e) => setTrainerDataResponse({ ...trainerDataResponse, state: e.target.value })}
                    />
                  </div>
                </Col>
              </Row>{" "}
                ...
                <Col>
                  <div controlId="qualification">
                    ...
                    <input
                      ...
                      disabled={!isEditable}
                      onChange={(e) => setTrainerDataResponse({ ...trainerDataResponse, qualification: e.target.value })}
                    />
                  </div>
                </Col>
                <Col>
                  <div controlId="experience">
                    ...
                    <input
                      ...
                      disabled={!isEditable}
                      onChange={(e) => setTrainerDataResponse({ ...trainerDataResponse, experience: e.target.value })}
                    />
                  </div>
                </Col>
                <Col>
                ...
                <Col>
                  <div controlId="mobile_no">
                    ...
                    <input
                      ...
                      disabled={!isEditable}
                      onChange={(e) => setTrainerDataResponse({ ...trainerDataResponse, mobile_no: e.target.value })}
                    />
                  </div>
                </Col>
                ...
                <Col>
                  <div controlId="email_id">
                    ...
                    <input
                      ...
                      disabled={!isEditable}
                      onChange={(e) => setTrainerDataResponse({ ...trainerDataResponse, email_id: e.target.value })}
                    />
                  </div>
                </Col>
                <Col>
                  <div controlId="languages_known">
                    ...
                    <input
                      ...
                      disabled={!isEditable}
                      onChange={(e) => setTrainerDataResponse({ ...trainerDataResponse, languages_known: e.target.value })}
                    />
                  </div>
                </Col>
              </Row>{" "}
                ...
                <Col>
                  <div controlId="bank_name">
                    ...
                    <input
                      ...
                      disabled={!isEditable}
                      onChange={(e) => setTrainerDataResponse({ ...trainerDataResponse, bank_name: e.target.value })}
                    />
                  </div>
                </Col>
                ...
                <Col>
                  <div controlId="ifsc_code">
                    ...
                    <input
                      ...
                      disabled={!isEditable}
                      onChange={(e) => setTrainerDataResponse({ ...trainerDataResponse, ifsc_code: e.target.value })}
                    />
                  </div>
                </Col>
                <Col>
                  <div controlId="branch_name">
                    ...
                    <input
                      ...
                      disabled={!isEditable}
                      onChange={(e) => setTrainerDataResponse({ ...trainerDataResponse, branch_name: e.target.value })}
                    />
                  </div>
                </Col>
              </Row>{" "}
              ...
              <Row md={12} className="row-12">
                <Col>
                  <div controlId="account_no">
                    ...
                    <input
                      ...
                      disabled={!isEditable}
                      onChange={(e) => setTrainerDataResponse({ ...trainerDataResponse, account_no: e.target.value })}
                    />
                  </div>
                </Col>
                ...
                <Col>
                  {isEditable ? (
                    ...
                    type="button"
                    name="resume"
                    onClick={handleResumeClick(trainerDataResponse.resume)}
                    required
                  /> */}
                    </div>
                  )}

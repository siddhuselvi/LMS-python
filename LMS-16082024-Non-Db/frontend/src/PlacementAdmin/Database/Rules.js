...
const RulesManagement = () => {
  ...
  return (
    <div>
      ...
      <img src={Add} style={{ marginRight: "2px" }} className='nextarrow' alt="Add" /> <strong>Rule</strong>
      </button>
      <p></p>
      {showAddForm && (
        <div className="popup-container">
          ...
          <div className='button-container'>
            <button className='button-ques-save' style={{ width: "100px" }} onClick={handleAddRule}>Save</button>

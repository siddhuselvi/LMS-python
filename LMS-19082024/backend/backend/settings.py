...
SILKY_PYTHON_PROFILER = False  # Enable Python profiler 
SILKY_AUTHENTICATION = False   # Set to True if you want to restrict access to Silk UI 
SILKY_AUTHORISATION = False    # Set to True if you want to restrict access to Silk UI 
SILKY_META = True             # Set to True to capture meta data about requests 

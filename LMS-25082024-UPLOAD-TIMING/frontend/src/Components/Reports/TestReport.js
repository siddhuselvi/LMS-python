...
import { getTestcandidateReportsApi,
...
const TestReport = () => {
  ...
  const getTestCandidates = () => {
    getTestcandidateReports_candidates_Api(test_name)
      .then(data => {
  ...
  return (
    ...
    <div className="product-table-container">
      ...
      <div style={{ display: 'flex' }}>
        <button className="add-products-button" style={{width:"110px", marginRight: '20px'}} onClick={exportToExcel}><img src={Download} className='nextarrow'></img><span>Export</span></button>
        <input

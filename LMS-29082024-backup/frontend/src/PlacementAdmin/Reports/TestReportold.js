...
import { getReports_College_API } from '../../api/endpoints';
...
const TestReports = ({ collegeName, username, institute }) => {
  ...
  const getTestCandidates = () => {
    getReports_College_API(institute)
      .then(data => {
    ...
    <div>
      <div className="product-table-container">
        ...
        <div style={{ display: 'flex' }}>
          <button className="button-ques-save" style={{ width: "100px", marginRight: '20px' }} onClick={exportToExcel}><img src={Download} alt="Download" className='nextarrow' /><span>Export</span></button>
          <input
        ...
        <div className='table-responsive'>
          <table className="product-table">
            <thead className="table-thead">
              <tr>
                <th style={{ textAlign: "center" }}>Test Name <br />
                  <select value={filters.test_name} onChange={(e) => handleFilterChange(e, 'test_name')} style={{ backgroundColor: 'white', borderRadius: '5px', width: "200px", textAlign: "center" }}>
                    <option value="">All</option>
                    {generateDropdownOptions('test_name')}
                  </select>
                </th>
               
                <th style={{ textAlign: "center" }}>Candidate <br />
                  <select value={filters.student_name} onChange={(e) => handleFilterChange(e, 'student_name')} style={{ backgroundColor: 'white', borderRadius: '5px', width: "160px",textAlign: "center" }}>
                    <option value="">All</option>
                    {generateDropdownOptions('student_name')}
                  </select>
                </th>
                <th style={{ textAlign: "center" }}>Year <br />
                  <select value={filters.year} onChange={(e) => handleFilterChange(e, 'year')} style={{ backgroundColor: 'white', borderRadius: '5px',textAlign: "center" }}>
                    <option value="">All</option>
                    {generateDropdownOptions('year')}
                  </select>
                </th>
                <th style={{ textAlign: "center" }}>Department <br />
                ...
                <th style={{ textAlign: "center" }}>Start Date
                    </th>
                <th style={{ textAlign: "center" }}>End Date
                    </th>
                <th style={{ textAlign: "center" }}>Scores <br />
                  <select value={filters.total_score} onChange={(e) => handleFilterChange(e, 'total_score')} style={{ backgroundColor: 'white', borderRadius: '5px',textAlign: "center" }}>
            ...
            {currentData
                ...
                <tr key={candidate.id} >
                  ...
                  <td style={{ textAlign: "center",width:"120px" }}>{candidate.dtm_start}</td>
                  <td style={{ textAlign: "center" ,width:"120px"}}>{candidate.dtm_end}</td>
                  <td style={{ textAlign: "center" }}>
                    {candidate.is_active ? candidate.total_score : 'AA'}
                  </td>
                </tr>
              ))}
            </tbody>

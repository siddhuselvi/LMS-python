...
import StudentsFeedback from './Components/LMS/StudensFeedback';
import TrainerFeedback from './Components/LMS/Trainerfeedback';



const App = ({ collegeName, username,userRole }) => {

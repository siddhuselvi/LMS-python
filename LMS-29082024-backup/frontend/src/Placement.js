...
import StudentList from './PlacementAdmin/Database/Studentslist';
import Uploadstudentdata from './PlacementAdmin/Database/uploadtable';
import EligibleStudents from './PlacementAdmin/Database/EligibleStudents';
import LoginCreate from './PlacementAdmin/Database/LoginCreate';
import PlacementReport from './PlacementAdmin/Reports/PlacementReport';


const PlacementAdmin = ({ collegeName, username, institute,userRole }) => {
                ...
                <ThemeContextProvider>
                  ...
                  <div className={`main-content ${isSidebarOpen ? 'shifted' : ''}`} style={{ marginTop: '60px' }}>
                    <Routes>
                      ...
                      <Route path="/uploadstudentdata" element={<Uploadstudentdata  institute={institute} />} />

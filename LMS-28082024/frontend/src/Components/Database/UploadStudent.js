...
const UploadStudentProfile = () => {
  ...
  /*  const exportTouser = () => {
    ...
    const handleExportMCQ = () => {
        ...
        link.download = 'Nondb.xlsx'; // Name of the file when downloaded
                                ...
                                <div className="sp-div">
                                    ...
                                    {selection === 'Database' ? (
                                        ...
                                        <div className="sp-inner-div" >
                                            ...
                                            <button className="button-data button-spacing spaces1" onClick={handleExportMCQ} style={{ width: "102px" }}><img src={Download} className='nextarrow'></img><span>Export</span></button>

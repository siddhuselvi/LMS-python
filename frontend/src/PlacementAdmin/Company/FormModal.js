    ...
    useEffect(() => {
        getcollegeApi()
            .then(data => {
                ...
                setCollege(data.map(item => ({ id: item.id, college: item.college })));
            })
                    ...
                    <Col>
                        <form onSubmit={handleSubmit} className='form-ques'>
                            <Row md={12}>
                                <Col>
                                    <div controlId='admin_name'>
                                        <label className='label8-ques'>Admin Name</label><p></p>
                            ...
                            <Row md={12}>
                                <Col>
                                    <div controlId='college_name'>
                                        <label className='label8-ques'>College Name</label><p></p>
                                        <Select
                                            options={college}
                            ...
                            <div className='button-container'>
                                <button type="submit" className="button-ques-save">Save</button>

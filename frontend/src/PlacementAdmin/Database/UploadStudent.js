...
import { getcollegeApi, getdepartmentApi, addcandidateApi, getcandidatesApi_ALL, getSkillApi, addLoginApi } from '../../api/endpoints';
...
const UploadStudentProfile = () => {
    ...
    /* const exportToExcel = () => {
         ...
         // Define a constant student object with the required values
         const constantStudent = {
           ...
           year: '3',
           cgpa: '9.0',
           department_id__department: 'CSE',
           marks_10th: '95',
           marks_12th: '90',
          // marks_semester_wise: '85, 88, 90',
         ...
         // Add the constant student object to the worksheet
         worksheet.addRow(constantStudent);
    ...
    /*
        const handleSubmit = (e) => {
            ...
            let skill_values = selectedskill.map(skill => skill.value);
            ...
            const studentprofile = {
                ...
                // marks_semester_wise: marksSemesterWise || '',
                ...
                number_of_offers: formData.get('number_of_offers') || '',
                it_of_offers: formData.get('it_of_offers') || '',
                core_of_offers: formData.get('core_of_offers') || '',
            ...
            addcandidateApi(studentprofile)
                .then((result) => {
                    ...
                    // After student profile is added successfully, submit login details
                    const loginDetails = {
                        email_id: formData.get('email_id') || '', // Assuming email_id is used for login email_id
                        college_id: selectedCollege.value,
                        user_name: formData.get('user_name'),
                        password: formData.get('password'), // You need to provide a password here
                        role: Students, // Assuming role is 'student'
                    };
                    return addLoginApi(loginDetails);
                })
                .then(() => {
                    // Both submissions were successful
                   // window.alert("Student Profile and Login added successfully");
    ...
    const handleSubmit = (e) => {
        ...
        addcandidateApi(studentprofile)
            ...
            .catch((error) => {
                console.error("Failed to Add. Check console for details.");  // Log the error to the console
                                    ...
                                    <Row >
                                        ...
                                        <Col>
                                            <div className='add-profile' controlId='history_of_arrears'>
                                                ...
                                                <input type="text" autocomplete="off" className="input-ques" min="0" name="history_of_arrears" placeholder="" />
                                            </div>
                                        </Col>
                                        <Col>
                                            <div className='add-profile' controlId='standing_arrears'>
                                                <label className='label7-ques'>Standing Arrears</label><p></p>
                                                <input type="number" autocomplete="off" className="input-ques" min="0" name="standing_arrears" placeholder="" />
                                            </div>
                                        </Col>
                                    </Row>
                                    <p></p>
                                    ...
                                    <Row>
                                        <Col>
                                            <div className="button-container-lms-update">
                                                ...
                                                <button className="button-ques-next next-button-lms"

...
import { addTestcandidateApiBatch, getTestsApi, getrulesApi, getcollegeApi, getquestionApi, getcandidatesApi, getdepartmentApi, getQuestionPaperApi, addTestsApi, gettesttypeApi, getSkilltypeApi, getqstntypeApi } from '../../api/endpoints';
...
const TestaccessForm = ({ onNextButtonClick, institute, collegeName }) => {
        ...
        <div className='start'>
            <div className='form-ques'>
                <div className='non-db-btn'>
                    <button className='button-ques-save  save-button-lms'>  <Link to='/test-access/non-db/' style={{ color: "black", textDecoration: "none" }}>Non Database</Link></button>
                                ...
                                <Row>
                                    <Col>
                                        ...
                                        <div className="button-container-lms">
                                            ...
                                            <button onClick={onNextButtonClick} className='button-ques-next next-button-lms'
                                                style={{
                                                    width: "100px",

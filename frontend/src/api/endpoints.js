...
export function addcoursecontentApi(course) {
  return axios.post(`${API_URL}/api/course/content/create/`, {
    id: null,
...
export function getcoursecontentApi() {
  return axios.get(`${API_URL}/api/course/content/`)
    .then(response => response.data)
}


export async function updatecoursecontentApi(id, course) {
  return axios.put(`${API_URL}/api/course/content/update/${id}/`, {
...
export function deletecoursecontentApi(id) {
  return axios.patch(`${API_URL}/api/course/content/${id}/delete/`)
    .then(response => response.data)
    .catch(error => {
      console.error('Error updating tests:', error);
      throw error;
...
export function getTrainerSkillMapApi() {
  return axios.get(`${API_URL}/api/get/trainer_skill_map/`)
    .then(response => response.data)
}
export function addTrainerSkillMapApi(log) {
  return axios.post(`${API_URL}/api/add/trainer_skill_map/`, {
    id: null,
    trainer_id: log.trainer_id,
...
export async function updateTrainerSkillMapApi(id, log) {
  return axios.put(`${API_URL}/api/update/trainer_skill_map/${id}/`, {
...
export function deleteTrainerSkillMapApi(id) {
  return axios.patch(`${API_URL}/api/delete/trainer_skill_map/${id}/`)
    .then(response => response.data)
    .catch(error => {
      console.error('Error updating tests:', error);
      throw error;
...
export function getTrainerAvailabilityApi() {
  return axios.get(`${API_URL}/api/get/trainer_availability/`)
    .then(response => response.data)
}
export function addTrainerAvailabilityApi(log) {
  return axios.post(`${API_URL}/api/add/trainer_availability/`, {
    id: null,
    trainer_id: log.trainer_id,
...
export async function updateTrainerAvailabilityApi(id, log) {
  return axios.put(`${API_URL}/api/update/trainer_availability/${id}/`, {
...
export function deleteTrainerAvailabilityApi(id) {
  return axios.patch(`${API_URL}/api/delete/trainer_availability/${id}/`)
    .then(response => response.data)
    .catch(error => {
      console.error('Error updating tests:', error);
      throw error;
...
export function getTrainerApi() {
  return axios.get(`${API_URL}/api/trainers/all/`)
    .then(response => response.data)
}
...
export async function updateCollege_logo_API(id, test) {
  console.log('test', test);
  return axios.put(`${API_URL}/api/colleges/updates/${id}/`, {
   
    college: test.college,
    college_logo: test.college_logo,   
  })
    .then(response => response.data);
}

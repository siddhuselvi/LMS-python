        ...
        <div className='table-responsive'>
          <table className="product-table">
            <thead className="table-thead">
              <tr>
                <th style={{ textAlign: "left" }}>Test Name <br />
                ...
                <th style={{ textAlign: "left" }}>Candidate <br />
                  <select value={filters.student_name} onChange={(e) => handleFilterChange(e, 'student_name')} style={{ backgroundColor: 'white', borderRadius: '5px', width: "160px",textAlign: "left" }}>
                    <option value="">All</option>
                    {generateDropdownOptions('student_name')}
                  </select>
                </th>
                <th style={{ textAlign: "left" }}>Year <br />
                  <select value={filters.year} onChange={(e) => handleFilterChange(e, 'year')} style={{ backgroundColor: 'white', borderRadius: '5px',textAlign: "left" }}>
                    <option value="">All</option>
                    {generateDropdownOptions('year')}
                  </select>
                </th>
                <th style={{ textAlign: "left" }}>Department <br />
                  <select value={filters.department_id} onChange={(e) => handleFilterChange(e, 'department_id')} style={{ backgroundColor: 'white', borderRadius: '5px',width:"90px",textAlign: "left" }}>
                    <option value="">All</option>
                    {generateDropdownOptions('department_id')}
                  </select>
                </th>
                <th style={{ textAlign: "left" }}>Start Date
                    </th>
                <th style={{ textAlign: "left" }}>End Date
                    </th>
                <th style={{ textAlign: "left" }}>Scores <br />
                  <select value={filters.total_score} onChange={(e) => handleFilterChange(e, 'total_score')} style={{ backgroundColor: 'white', borderRadius: '5px',textAlign: "left" }}>

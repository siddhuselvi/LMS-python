...
const NonDatabaseForm = ({collegeName}) => {
    ...
    }, [collegeName, selectedTestType, selectedTestTypeCategory, selectedQuestionType, selectedSkillType, duration, selectedCollege]);
...
useEffect(() => {
    if (selectedCollege?.value) {
        console.log('Selected College ID:', selectedCollege.value); // Log the selected college ID
        ...
        console.log('No college selected or selectedCollege is null.'); // Log if no college is selected
    }
}, [selectedCollege]);

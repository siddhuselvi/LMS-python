...
import { deleteQuestionPaperLast_API,
  QuestionsExportAPI,
...
import Word from '../../assets/Coding.docx'




const ImportCodeWord = ({ isFormValid, formData }) => {
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      const response = await WordImportCoding_Api(formDataToSend);

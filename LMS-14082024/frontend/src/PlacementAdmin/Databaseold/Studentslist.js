...
const FilterDropdown = ({ options, selectedValue, onChange }) => {
  return (
    <select
      ...
      style={{ backgroundColor: 'darkgray', borderRadius: '5px', display: 'flex', width: '100px' }}
    >
...
const StudentList = () => {
 ...
 const filterOptions = {
  ...
  students_id__department_id__department: [...new Set(students.map((student) => student.students_id__department_id__department))],
          ...
          <thead className="table-thead">
            <tr>
              ...
              <th>
                Department
                <FilterDropdown
                  options={filterOptions.students_id__department_id__department}
                  selectedValue={filters.students_id__department_id__department}
                  onChange={(value) => handleFilterChange('students_id__department_id__department', value)}
                />
              </th>

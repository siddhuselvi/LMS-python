...
const TopicManagement = () => {
  ...
  return (
    <div>
      ...
      <img src={Add} className='nextarrow' alt="Add Skill" style={{ marginRight: "2px" }}/> <strong>Topic</strong>
      </button>
      <p></p>
      {showAddForm && (
        <div className="popup-container">
          ...
          <div className='button-container'>
            <button className='button-ques-save' style={{ width: "100px" }} onClick={handleAddTopic}>Save</button>

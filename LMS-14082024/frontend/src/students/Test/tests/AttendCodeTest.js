            ...
            <div>
                <div className="questions-container-code">
                    {questions.map(question => {
                        // Find the test answer for the current question
                        ...
                        // Check if the question is completed based on the updated conditions
                        const isCompleted = completedQuestions.includes(question.id) ||
                            (testAnswer && completedQuestions.includes(testAnswer.question_id__id));

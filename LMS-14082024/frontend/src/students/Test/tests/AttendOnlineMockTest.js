                    ...
                    <div className='test-container-mcq'>
                        ...
                        <div className="question-container1-mcq">
                            <div key={questions[currentQuestionIndex].id}>
                                ...
                                <pre><code>{questions[currentQuestionIndex].question_text}</code></pre>
                                ...
                                <ul style={{ listStyleType: 'none', padding: 0 }}>
                                    {['A', 'B', 'C', 'D'].map(optionLabel => {
                                        ...
                                        // Render only if optionText is not empty
                                        if (optionText) {
                                            return (
                                                    ...
                                                    <label style={{ cursor: 'pointer', display: 'flex' }}>
                                                        ...
                                                        >
                                                            ...
                                                            {questions[currentQuestionIndex][`option_${optionLabel.toLowerCase()}_image_data`] && (
                                                                <BinaryToImages binaryData={questions[currentQuestionIndex][`option_${optionLabel.toLowerCase()}_image_data`]} width="60px" height="60px" />
                                                            )}
                                                        </div>
                                                    </label>
                                                </li>

...
urlpatterns = [
   ...
   # path('api/tests/delete/<int:pk>/', views.testsRetrievedeleteAPIView.as_view(), name='tests-delete'),
    ...
    path('api/testcandidate/<int:pk>/updatedDatabase/', views.update_testcandidatemap_status_login, name='update-isactive-tests-candidates-map'),
   ...
   #  path('api/candidates-eligible-list/', views.get_candidate_all_job_master, name='get_candidate_all_job_master'),
    ...
    path('api/eligible-student/update/<int:student_id>/', views.update_eligible_student, name='update_eligible_student'),
    ...
    path('api/get_total_marks/<int:student_id>/<str:test_name>/', views.get_total_marks, name='get_total_marks'),

    path('question_master/<int:question_id>/update/', views.update_question, name='update_question'),

...
import TrainingSchedule from './students/Database/TrainingSchedule';
import './App.css';
...
const Students = ({ collegeName, username, institute }) => {
      ...
      <Router>
        ...
        <div className={`app ${theme}`}>
          <SearchProvider>
            ...
            {needInfo === true ? (
              <Uploadstudent username={username} collegeName={collegeName} />
            ) : (
              <div>
                <ThemeContextProvider>
                  ...
                  <div className={`main-content ${isSidebarOpen ? 'shifted' : ''}`} style={{ marginTop: '60px' }}>
                    <TestProvider>
                      <Routes>
                        <Route path="/" element={<Dashboard username={username} collegeName={collegeName} isSidebarOpen={isSidebarOpen} disableSidebar={disableSidebar} enableSidebar={enableSidebar} />} />
                        ...
                        <Route path="/database/trainingschdl" element={<TrainingSchedule username={username} collegeName={collegeName} />} />

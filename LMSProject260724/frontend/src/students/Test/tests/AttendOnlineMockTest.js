...
import Teacher from '../../../assets/Images/teacherright.png';
import TeacherLeft from '../../../assets/Images/Teacherleft.png';
   ...
   // const [isSidebarDisabled, setIsSidebarDisabled] = useState(false);
    ...
    const renderTimer = () => {
        if (selectedTestCandidate.duration_type === 'Start&EndTime') {
            ...
            return (
                <McqTimer
                    duration={remainingTimeFromEndTime <= 0 || moment().isSameOrAfter(moment(selectedTestCandidate.dtm_end))
                        ? 0
                        : remainingTime} // Pass duration in seconds
        ...
        if (testCompleted) {
            ...
            return (
                <>
                    ...
                    <div className='dash-border'><h6 style={{ textAlign: "center" }}>He You Go...</h6></div><br></br>
                    ...
                    <div className='test-container-mcq'>
                        ...
                        <div className="question-container1-mcq">
                            <div key={questions[currentQuestionIndex].id}>
                                <p className='questions'>{currentQuestionIndex + 1}) {questions[currentQuestionIndex].question_text}
                                    {questions[currentQuestionIndex].question_image_data && (
                                        <img
                                            src={`data:image/jpeg;base64,${questions[currentQuestionIndex].question_image_data}`}
                                            alt="Question"
                                        ...
                                        return (
                                            <li key={optionLabel} style={{ marginBottom: '10px' }}>
                                                <label style={{ cursor: 'pointer', display: 'flex' }}>
                                                    ...
                                                    >
                                                        {optionText}
                                                        {questions[currentQuestionIndex][`option_${optionLabel.toLowerCase()}_image_data`] && (
                                                            <img
                                                                src={`data:image/jpeg;base64,${questions[currentQuestionIndex][`option_${optionLabel.toLowerCase()}_image_data`]}`}
                                                                alt="Question"
                                                                style={{ width: '50px', height: 'auto' }}
                                                            />
                                                        )}

...
const Dashboard = ({ collegeName, username }) => {
  ...
  */}
  ...
  useEffect(() => {
   ...
   // getTotalPresentAttendance();
   // getTotalAbsentAttendance();
    getUpcomming();
    getOfferStatus();
    getOfferPackage();
    getStudentCmpyDet();
    ...
    fetchDepartmentId();
    fetchCompany();
  }, [collegeId, avgAptitudeScore, avgCodingScore, clgTopper, clgTopperCode, avgPresent, avgAbsent, upcomming, offerStatus, offerPackage, studentCmpyDet, totOffers, totRequest, deptId]);

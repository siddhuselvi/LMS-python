...
function Importuser() {
  ...
  return (
    <div className="sp-inner-div" style={{ marginLeft: "80px" }}>
      <input type="file" onChange={handleFileChange} />
      <button onClick={handleUpload} className="button-data" style={{ width: "102px" }} ><img className='nextarrow' src={Upload}></img><span>Upload</span></button>
